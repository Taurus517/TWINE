...
filename1 = "./Upper/TWINE-80_Boomerang_Pr_RK_" + str(r0) + "R_Upper_" + str(total_Pr_E0) + "Pr.cvc"
f1 = open(filename1, "w")
filename2 = "./Lower/TWINE-80_Boomerang_Pr_RK_" + str(r1) + "R_Lower_" + str(total_Pr_E1) + "Pr.cvc"
f2 = open(filename2, "w")
