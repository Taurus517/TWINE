...
int main(){
    ...
    sprintf(filename1, "stp T-TWINE-80_Boomerang_Pr_RK_%dR_Upper_%dPr.cvc", r0, total_Pr_E0);
    sprintf(filename2, "T-TWINE-80_Boomerang_Pr_RK_%dR_Upper_%dPr.cvc", r0, total_Pr_E0);
