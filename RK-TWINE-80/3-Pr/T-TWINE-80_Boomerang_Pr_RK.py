...
(r0,r1) = (6, 5) #
(total_Pr_E0, total_Pr_E1) = (7, 7) #
Data = [
["0000001100110000000100001100000000000000000001000000000000100000000000000100000000000010000000000001000000000000", 
"000000010000100000001000000000000001000000000000000000100000000000000000010000000000000000100000"],
["00000001000000000000000100000000000000000000000000000000001000000000000000100000000000000010000000000000001000000000000000100000000000000000", 
"000000000000010000000000000000000000010000100000000000000000000000100000000000000000000000100000000000000000000000100000"]
] #

filename1 = "./Upper/T-TWINE-80_Boomerang_Pr_RK_" + str(r0) + "R_Upper_" + str(total_Pr_E0) + "Pr.cvc"
f1 = open(filename1, "w")
filename2 = "./Lower/T-TWINE-80_Boomerang_Pr_RK_" + str(r1) + "R_Lower_" + str(total_Pr_E1) + "Pr.cvc"
f2 = open(filename2, "w")
...
Set_Init(f1, 'APE0_K0', Data[1][0], 0, r0+1, 20, 1)
f1.write("\n")
...
Set_Init(f2, 'APE1_K0', Data[1][1], 0, r1+1, 20, 1)
f2.write("\n")
