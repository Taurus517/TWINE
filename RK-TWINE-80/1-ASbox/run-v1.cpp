...
int main(){
    ...
    for(int totalASAK = 57; totalASAK < 64; totalASAK++){ //
        ...
        sprintf(filename, "stp T-TWINE-80_Boomerang_ASbox_RK_%d+%d+%dR_%dASAK.cvc", r0, rm, r1, totalASAK); 
        ...
        sprintf(filename1, "rm T-TWINE-80_Boomerang_ASbox_RK_%d+%d+%dR_%dASAK.cvc", r0, rm, r1, totalASAK); 
        FILE *fRemove = NULL; 
