...
for (r0,rm,r1) in ((8,5,9),
    ...
    for totalASAK in range(57,64):

        filename = "T-TWINE-80_Boomerang_ASbox_RK_" + str(r0) + "+" + str(rm) + "+" + str(r1) + "R_" + str(totalASAK) + "ASAK.cvc"
        f = open(filename, "w")
        ...
        Var_X(f, 'AK_E0', 0, r0, 2, 3)
        Var_X(f, 'AK_UEm', r0, r0+rm, 2, 3)
        ...
        Var_X(f, 'AK_E1', 0, r1, 2, 3)
        Var_X(f, 'AK_LEm', r1, r1+rm, 2, 3)
        ...
        f.write("ASSERT total_RK = 0bin" + str(tobits(total_RKE1, 8)) + ";\n\n")
