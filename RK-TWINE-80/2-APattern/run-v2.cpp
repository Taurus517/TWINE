...
int main(){
    ...
    sprintf(filename1, "stp T-TWINE-80_Boomerang_AP_RK_%d+%d+%dR.cvc", r0, rm, r1);
    sprintf(filename2, "T-TWINE-80_Boomerang_AP_RK_%d+%d+%dR.cvc", r0, rm, r1);
