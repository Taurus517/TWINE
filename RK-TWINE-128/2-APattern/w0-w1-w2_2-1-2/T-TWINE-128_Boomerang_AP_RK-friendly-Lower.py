...
filename = "T-TWINE-128_Boomerang_AP_RK_" + str(r0) + "+" + str(rm) + "+" + str(r1) + "R.cvc"
f = open(filename, "w")
...
Var_X(f, 'AK_E0', 0, r0, 3, 2)
Var_X(f, 'AK_UEm', r0, r0+rm, 3, 2)
...
Var_X(f, 'AK_E1', 0, r1, 3, 2)
Var_X(f, 'AK_LEm', r1, r1+rm, 3, 2)
...
Var_X(f, 'APE0_K0', 0, r0+1, 32, 1)
Var_X(f, 'APE1_K0', 0, r1+1, 32, 1)
