...
int main(){
    ...
    for(int totalASAK = 56; totalASAK < 64; totalASAK++){ //
        ...
        sprintf(filename, "stp TWINE-128_Boomerang_ASbox_RK_%d+%d+%dR_%dASAK.cvc", r0, rm, r1, totalASAK); 
        ...
        sprintf(filename1, "rm TWINE-128_Boomerang_ASbox_RK_%d+%d+%dR_%dASAK.cvc", r0, rm, r1, totalASAK); 
        FILE *fRemove = NULL; 
