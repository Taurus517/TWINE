...
int main(){
    ...
    sprintf(filename1, "stp TWINE-128_Boomerang_Pr_RK_%dR_Lower_%dPr.cvc", r1, total_Pr_E1);
    sprintf(filename2, "TWINE-128_Boomerang_Pr_RK_%dR_Lower_%dPr.cvc", r1, total_Pr_E1);
