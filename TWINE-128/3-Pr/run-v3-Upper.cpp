...
int main(){
    ...
    sprintf(filename1, "stp TWINE-128_Boomerang_Pr_RK_%dR_Upper_%dPr.cvc", r0, total_Pr_E0);
    sprintf(filename2, "TWINE-128_Boomerang_Pr_RK_%dR_Upper_%dPr.cvc", r0, total_Pr_E0);
